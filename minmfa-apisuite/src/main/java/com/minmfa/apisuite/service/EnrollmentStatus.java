...
public final class EnrollmentStatus {
	...
	private static void getEnrollmentStatus(String clientKey, String clientSecret, String userName) {
		...
		restTemplate.exchange("https://dev.minaws.com/api/minmfa/v1/enrollstatus?username=" + userName, HttpMethod.GET,
				entity, Map.class);
	}
}
