...
public final class RegisterDevice {
	...
	private static void registerDevice(String clientKey, String clientSecret) {
		...
		restTemplate.exchange("https://dev.minaws.com/api/minmfa/v1/register/device", HttpMethod.POST, entity,
				List.class);
	}
}
